...
M_0 = 0.51099895000 # MeV/c^2 == 1e6 eV/c^2
...
def kinetic_wannier(kx_matrix, ky_matrix, mu=M_STAR):
    """
...
def main():
    ...
    define_grid_k(5, 51)
    # file_name_metadata = "../Data/info_wannier_conv_and_wave_funct_125"
    ...
    first_call_to_compile_Coulomb_potential() # Just to compilate: doesn't return anything
    ...
    print("\n\nSaving...")
    # file_name = "../Data/data_wannier_conv_and_wave_funct_125"
    print(values[0])
...
Notes about performance:
    ...
    - For 5 different systems, with 121 x 121 discrete points each, it took 67 min to terminate;

    WITH NUMBA:
    - For 5 different systems, with 115 x 115 discrete points each, it took 31 min to terminate;
    - For 5 different systems, with 125 x 125 discrete points each, it took 51 min to terminate;
"""
